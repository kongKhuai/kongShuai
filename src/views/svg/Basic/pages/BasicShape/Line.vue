 ...
 * @Date: 2024-04-18 22:25:21
 * @LastEditors: 16651618507@163.com
 * @LastEditTime: 2024-04-18 22:32:47
 * @FilePath: \new-plus\src\views\svg\Basic\pages\BasicShape\Line.vue
 * @Description: 
 * 
-->
<!-- 线段 -->
<template>
  <svg class="svg__x">
    ...
    <line
      ...
      x2="360"
      y2="20"
      style="stroke: #118df0; stroke-width: 5; stroke-opacity: 0.2"
    />
    <line
      x1="300"
      y1="40"
      x2="360"
      y2="40"
      style="stroke: #118df0; stroke-width: 5; stroke-opacity: 0.4"
    />
    <line
      x1="300"
      y1="60"
  ...
  <aside class="explain">
    <ul>
      ...
      <li>
        stroke
        笔画颜色，可以使用颜色关键字、6位十六进制、3位十六进制、rgb和currentColor表示。currentColor代表继承父容器的color
      </li>
      <li>
        其他表示颜色的方法：rgba()、hsl()、hsla()、transparent，这些都是来自CSS3颜色规范，不输入SVG1.1规范，可能存在一定兼容性问题
      </li>
      <li>stroke-width 是画笔宽度，可以在 style 指定</li>
      <li>
        stroke-opacity 控制线条不透明度。取值范围：0 ~
        1，0代表完全透明，1代表完全不透明。小于0的值会更改为0，大于1的值会更改为1.
      </li>
      <li>
        stroke-dasharray
        点线或虚线。值为数字构成，代表虚线和缝隙的长度，数字间用逗号或者空格分隔。注意最下面那条线是奇数的情况。
      </li>
    </ul>
  </aside>
</template>
